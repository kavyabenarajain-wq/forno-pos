// tweaks-panel.jsx — standalone version
// Floating Tweaks panel + form-control helpers. In production it is closed by
// default and opened via window.openTweaks() (wired to a button in the topbar).
...
// Persisted tweak state (localStorage), no host protocol.
const TWEAKS_LS_KEY = 'forno-pos-tweaks';
...
// Open / close the panel via window.openTweaks() / window.closeTweaks().
function TweaksPanel({ title = 'Tweaks', children }) {
  ...
  React.useEffect(() => {
    ...
    window.toggleTweaks = () => setOpen(o => !o);
    return () => {
      delete window.openTweaks;
      delete window.closeTweaks;
      delete window.toggleTweaks;
    };
  }, []);
